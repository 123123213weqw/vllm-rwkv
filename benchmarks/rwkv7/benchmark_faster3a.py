...
ACCEPTANCE_THRESHOLDS = {
    "model_only_steady_decode": {
        # Release gate: the integrated path must not ship below the pinned
        # Albatross implementation on the same GPU/checkpoint/BxT case.
        "min_vllm_to_albatross_ratio": 1.0,
        "max_latency_slowdown_pct": 0.0,
    },
